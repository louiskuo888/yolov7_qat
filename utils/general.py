...
DATASETS_DIR = Path(os.getenv('YOLOv7_DATASETS_DIR', ROOT.parent / 'datasets'))  # global datasets directory
        ...
        if os.path.isfile(url):
            ...
            for i in range(retry + 1):
                ...
                if success:
                    ...
                    logger.info(f'Download failure, retrying {i + 1}/{retry} {url}...')
                else:
                    logger.info(f'ailed to download {url}...')
